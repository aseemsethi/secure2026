 ...
 */
void security_text_display(u8g2_t *u8g2)
{
    ...
    u8g2_DrawStr(u8g2, 0, 32, "aseemsethi@yahoo.com");

    /* Small font */
    u8g2_SetFont(u8g2, u8g2_font_5x7_tr);
    u8g2_DrawStr(u8g2, 0, 44, "Sept 2026");
    u8g2_DrawStr(u8g2, 0, 54, "Bengaluru, India");

    u8g2_SendBuffer(u8g2);
    vTaskDelay(pdMS_TO_TICKS(6000));    /* delay for showing static display */
}
